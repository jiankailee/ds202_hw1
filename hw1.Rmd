---
title: "hw1"
author: 'Jian Kai Lee; Github: jiankailee'
date: "1/15/2020"
output:
...
My thought on data science job is about clean,extract and analyze the generated data from the sources. The job related to data science is ***data scienctist***. Data Scientist use variety of programming language, technique and library mainly R and Python to produce a readable visual diagrams and documentation for people who have no programming background. Beside that, data scientists create a statistic model to extract and interpret data. They spend more a lot of time in collect, clean and mug data. 
[link](https://www.sas.com/en_us/insights/analytics/what-is-a-data-scientist.html)
<https://www.sas.com/en_us/insights/analytics/what-is-a-data-scientist.html>
![image](https://www.vault.com/media/17765/ccbdgn7vaaabvef.jpg)
